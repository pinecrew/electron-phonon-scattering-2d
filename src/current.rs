...
fn fields_from_config(conf: &Ini) -> Fields {
    ...
    f.e.0 = get_element!(section, "E0", Vec2::zero());
    f.e.1 = get_element!(section, "E1", Vec2::zero());
    f.e.2 = get_element!(section, "E2", Vec2::zero());
    f.b.0 = get_element!(section, "B0", 0.0);
    f.b.1 = get_element!(section, "B1", 0.0);
    f.b.2 = get_element!(section, "B2", 0.0);
    f.omega.1 = get_element!(section, "omega1", 0.0);
    f.omega.2 = get_element!(section, "omega2", 0.0);
